import { Home, Zap, Star, Shield, LogOut, Trophy, Activity, Radar, ZoomIn, ZoomOut, Lightbulb, Banknote, Target, Crosshair } from "lucide-react";
              ...
              {profile?.is_admin && (
                <>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <NavLink
                        to="/betting-execution"
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 hover:bg-white/5 hover:text-white transition-colors"
                        onClick={handleNavClick} activeClassName="bg-orange-500/10 text-orange-500 font-bold"
                      >
                        <Banknote className="h-5 w-5 shrink-0 text-orange-500" />
                        {!collapsed && <span className="text-sm">Execução</span>}
                      </NavLink>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>

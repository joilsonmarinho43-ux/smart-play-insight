...
const Live = () => {
  // Busca os jogos ao vivo com atualização automática a cada 60 segundos
  const { data: matches, isLoading, error, isFetching } = useQuery({
      ...
      <main className="container max-w-3xl mx-auto px-4 py-6 space-y-6">
        {isLoading && (
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground font-medium">Sintonizando jogos em andamento...</p>
          </div>
        )}
        ...
        {!isLoading && matches?.length === 0 && (
          <div className="text-center py-20 bg-secondary/20 rounded-2xl border border-dashed border-border">
            ...
            <p className="text-muted-foreground">Não há jogos das suas ligas principais acontecendo agora.</p>

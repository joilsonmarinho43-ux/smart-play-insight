...
const Paywall = () => {
  ...
  const trialEnd = profile
    ? new Date(new Date(profile.created_at).getTime() + 3 * 24 * 60 * 60 * 1000).toLocaleDateString('pt-BR')
    : '';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            {trialEnd && (
              <p className="text-xs text-muted-foreground">
                Período de teste encerrado em: {trialEnd}
              </p>
            )}
          </div>
          ...
          <a
            href="https://wa.me/5591986215730?text=Olá,%20gostaria%20de%20renovar%20meu%20acesso%20ao%20Match%20Insight%20Pro."
            target="_blank"
